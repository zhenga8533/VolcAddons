...
}).setCriteria("note.harp"), () => getWorld() === "Hub" && settings.dianaWaypoint && getPerks().has("Mythological Ritual"));
...
}), () => getWorld() === "Hub" && settings.dianaWaypoint && getPerks().has("Mythological Ritual"));
