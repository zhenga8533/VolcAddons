...
${AQUA}Insta Sell + Buy Order: ${WHITE + commafy(p1)} ${GRAY}(${commafy(
      p1 / 6
    )} per teeth)
${AQUA}Insta Sell + Insta Buy: ${WHITE + commafy(p2)} ${GRAY}(${commafy(
      p2 / 6
    )} per teeth)
${AQUA}Sell Offer + Buy Order: ${WHITE + commafy(p3)} ${GRAY}(${commafy(
      p3 / 6
    )} per teeth)
${AQUA}Sell Offer + Insta Buy: ${WHITE + commafy(p4)} ${GRAY}(${commafy(
      p4 / 6
    )} per teeth)\n`
  );
}
