...
public class VolcAddons {
        ...
        try {
            ...
            if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                if (!latestVersion.equals(VERSION)) {
                    sender.addChatMessage(new ChatComponentText("A new update is available!"));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    // Simple test method that references the VolcAddons class
    public static void testMethod() {
        System.out.println("This is a test method from the VolcAddons class.");
    }
}
