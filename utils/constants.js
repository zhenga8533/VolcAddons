...
export const RIFT_NPCS = {
    ...
    "argofay threebrother" : [
        ["Onebrother", -99, 76, 154],
        ["Twobrother", -93, 76, 109], 
        ["Threebrother", -136, 75, 113]],
    "threebrother" : [
        ["Onebrother", -99, 76, 154],
        ["Twobrother", -93, 76, 109], 
        ["Threebrother", -136, 75, 113]],
    "argofay trafficker" : [
        ["Cap Trafficker", -151, 112, 115],
        ["Top Trafficker", -138, 97, 113],
        ["Leggings Trafficker", -92, 90, 107],
        ["Boots Trafficker", -136, 88, 114]],
    "trafficker" : [
        ["Cap Trafficker", -151, 112, 115],
        ["Top Trafficker", -138, 97, 113],
        ["Leggings Trafficker", -92, 90, 107],
    ...
    "detective amog" : [
        ...
        ["Amogus 8", -51, 68, -41]],
    "disinfestor" : [
        ["Disinfestor 1", -38, 71, -103],
        ["Disinfestor 2", -40, 70, -88],
        ["Disinfestor 3", -38, 77, -94],
        ["Disinfestor 4", -33, 77, -89]],
    ...
    "dust" : ["Dust", -12, 71, -100],
    "elise" : [
        ["Elise (Wizard Tower)", -51, 122, 70],
        ["Elise (Rift Gallery)", 10, 55, 76]],
    "fafnir" : ["Fafnir", -128, 73, 173],
    "fairylosopher" : [
        ["Fairylosopher 1", 262, 106, 76],
        ["Fairylosopher 2", 256, 130, 75],
        ["Fairylosopher 3", 256, 123, 84],
        ["Fairylosopher 4", 256, 123, 87],
        ["Fairylosopher 5", 253, 123, 90],
        ["Fairylosopher 6", 250, 123, 88],
        ["Fairylosopher 7", 250, 123, 85]],
    ...
    "maddox the slayer" : ["Maddox the Slayer", 0, 0, 0],
    "maddox" : ["Maddox the Slayer", 0, 0, 0],
    "marcia" : ["Marcia", 3, 71, -11],
    "master tactician fink" : ["Master Tactician Fink", -192, 72, -57],
    "fink" : ["Master Tactician Fink", -192, 72, -57],
    "mole" : ["Mole", -160, 97, -76],
    "motes grubber" : [
        ["Motes Grubber (Wyld Woods)", -93, 65, 157],
        ["Motes Grubber (West Village)", -93, 71, -73]],
...
export const ZONES = {
    "wizard tower" : ["Wizard Tower", 0, 0, 0],
